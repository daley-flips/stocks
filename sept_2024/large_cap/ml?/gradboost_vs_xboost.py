...
models = [
    ...
    XGBClassifier(n_estimators=300, learning_rate=0.01, max_depth=4),
    XGBClassifier(n_estimators=100, learning_rate=0.1, max_depth=2),
    XGBClassifier(n_estimators=100, learning_rate=0.05, max_depth=10),
    XGBClassifier(n_estimators=250, learning_rate=0.03, max_depth=7),
    XGBClassifier(n_estimators=200, learning_rate=0.05, max_depth=6, colsample_bytree=0.8, subsample=0.8),
    XGBClassifier(n_estimators=150, learning_rate=0.1, max_depth=5, reg_lambda=1.0),
]
